...
router.get('/:id', hitCacheTransactionDetail, transactionController.getTransaction);
router.post('/', transactionController.insertTransaction);
router.put('/:id', clearCacheTransactionDetail, transactionController.updateTransaction);
router.delete('/:id', clearCacheTransactionDetail, transactionController.deleteTransaction);

router.get('/invoice/:id', hitCacheTransactionInvoice, transactionController.getInvoiceTransaction);
